...
| Figure 1 AP-Mbps Pareto | `artifacts/pareto_20260719/pareto_source.csv` | `c63e0c2` | usable with caveats | Pure late prediction sharing 必须和 raw-LiDAR Pareto frontier 分开解释；当前源表已包含 SGCP/PACP 与 Random/Density/Link-aware first-pass budget 点。 |
