...
- [ ] 将所有后续 FullPerception-PCS 实验固定为 raw-LiDAR adaptation 参数 `div4/radius4/min128`，并重跑/刷新 Table 1 PCS、Table 2/6 PCS + global box aggregation、Table 3/A 中 SGCP-scaffold PCS。2026-07-21 已将 `pcs.py` 默认值改为 `blind_spot_min_division=4`、`blind_spot_adjacency_radius=4`、`blind_spot_min_grids=128`，旧 PCS 数字若未显式标注该参数，只能作为 archived diagnostic。
