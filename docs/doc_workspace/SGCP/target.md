...
- [x] 生成 protocol-native compute profile：`docs/doc_workspace/SGCP/artifacts/compute_profile_20260722/compute_profile_protocol_native_20260722.csv`。Table1 PCS/EdgeCooper no-late 原版适配均约 `20` detector forwards/frame，PCS total `1788.63 GFLOPs/frame`、EdgeCooper total `1790.29 GFLOPs/frame`，但输入点数和通信负载不同。
