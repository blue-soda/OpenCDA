...
- [x] Table4 / parameter sensitivity：2026-07-23 已按 clean package 当前主点重新完成 41 帧感知实验，而不是沿用旧 strict/default trace。固定 attentive、40MHz、10 target subchannels、PAPG、coalition-game、inter-cluster NMS、`N_max=4/rho_th=3/head_rb_budget=2`，新增 `rho_th`、`N_max`、target-subchannels 和 communication-budget sweep，并补齐 raw/box/total Mbps 与 GFLOPs。结果文件：`docs/doc_workspace/SGCP/artifacts/parameter_sensitivity_current_protocol_20260723/`，clean package 文档：`C:\Workspace\2026-7-papers\infocom\SGCP\experiment\06_parameter_sensitivity.md`。
