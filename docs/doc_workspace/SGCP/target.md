...
- [ ] 比较 full-reference 与 SGCP 在漏检 GT box/near-box 内的点数差距：确认 full-reference 检出的关键增益来自更多点、更完整视角、还是特定 CAV 的近距离实例支撑；据此设计不显得“补丁化”的 instance-support-aware PPS utility。
