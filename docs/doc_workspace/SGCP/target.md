...
- [ ] 新增 object-level point association：对 dense-miss top40 统计 selected grid 内有多少上传点真正落入 GT 3D box 或其邻域，区分“grid 有点但目标无点/点太少”和“目标有点但 detector 仍无框”；据此设计 box/instance-aware grid scoring 或 point selection。
