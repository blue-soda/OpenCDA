...
- [ ] 设计 instance-support-aware PPS utility：在 PAPG coverage layer / target layer 叙事内，将“最佳实例视角到相关 cluster head”的支撑度加入候选 sender/grid utility，并保持同一 20MHz/10ch/`B_h=2` 预算验证 AP 与 Mbps。
