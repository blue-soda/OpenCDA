...
6. EdgeCooper-global reaches `0.81/0.77/0.42` at 74.58 Mbps in the offline proxy, but true NS3 replay completes only 73/110 requests; it is useful as an edge-assisted high-AP diagnostic, while PAPG remains the stronger deadline-feasible V2V line at 62.54 Mbps and 110/110 delivery.
