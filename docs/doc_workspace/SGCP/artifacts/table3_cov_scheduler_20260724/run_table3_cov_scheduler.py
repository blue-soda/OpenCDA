# -*- coding: utf-8 -*-
"""Run Table 3 scheduler comparison under the formal SGCP-CV scaffold.

This script intentionally leaves core algorithm code untouched. It reruns
non-SGCP schedulers with:

- attentive detector checkpoint,
- cov_coalition_game clustering,
- inter-cluster box NMS,
- NS3-calibrated channel estimator,
- K=2 receiver-side concurrent inbound links for the paper-facing rows.
"""
...
RUNS = [
    ...
    },
    {
        ...
        "args": [
            ...
            "--pcs-min-spot-grids", "128",
            "--pcs-communication-range-m", "35",
            "--max-senders-per-receiver", "1",
        ],
    },
    {
        "name": "edgecooper_hd_k1_note",
        "args": [
            "--selective-sharing-baseline", "edgecooper_global_hd",
            "--selective-member-budget", "3",
            "--selective-grid-budget", "117",
