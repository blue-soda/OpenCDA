...
- `FullPerceptionPCS_attentive` reaches `0.63/0.49/0.17` at `32.06 Mbps`; it uses paper-faithful PCS scheduling and raw-LiDAR full-sender upload adaptation. The stricter PCS blind-spot grid replay is lower payload and kept as a boundary result.
