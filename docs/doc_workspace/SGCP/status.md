...
- 已补 P8 qualitative case study 文字草稿：`docs\doc_workspace\SGCP\artifacts\appendix_support_20260719\qualitative_case_study.md`。当前选取 frame/object `000068/438`、`000066/401`、`000062/337`，分别说明 best-view sender 未调度、receiver/sender 选择不当、dense grid 但 object-level detector support 不足三类失败模式。若进入论文，还需要生成对应 BEV overlay 图。
