...
- 已新增 `artifacts/checkpoint_sensitivity_20260719/detector_checkpoint_sensitivity_manifest.csv` 和说明文档，统一汇总 mainline、actual-late、attentive、COSDH checkpoint probes。该 artifact 将 attentive 证据固定为 appendix/rebuttal sensitivity，不改变主表；远程 fine-tune checkpoint 回收后必须新建 artifact 目录重跑 SGCP/Pure late/Full20Early。
