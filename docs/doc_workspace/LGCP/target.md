...
- [ ] 实现 LGCP 专用 RSU area assignment、leader local fusion 和 RSU global aggregation 管线。（已完成 offline assignment / upload plan 和 leader/RSU aggregation proxy；真实 feature slicing + model-level fusion 仍待实现）
