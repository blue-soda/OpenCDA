    ...
    def __init__(self, apply_ml=False,
        ...
        if apply_ml and apply_cp and coperception_params:
            ml_manager = getattr(importlib.import_module(
                "opencda.core.ml_libs.opencood_manager"), 'OpenCOODManager')
            print("opencda.core.ml_libs.opencood_manager", 'OpenCOODManager')
            ...
            ml_manager = getattr(importlib.import_module(
                "opencda.core.ml_libs.ml_manager"), 'MLManager')
            print("opencda.core.ml_libs.ml_manager", 'MLManager')
